...
export default function SatelliteApp() {
  ...
  async function copyResults() {
    ...
    if (!navigator.clipboard?.writeText) {
      setDataWarning("Clipboard is not available in this browser context.");
      return;
    }
    ...
    try {
      ...
      setDataWarning(error instanceof Error ? error.message : "Failed to copy results to clipboard.");
    }
  }
